...
@contextlib.contextmanager
def mock_load_words(module):
    old_load_words = getattr(module, "load_words")
    load_words = MagicMock(return_value=["castle"])    

    try:
        setattr(module, "load_words", load_words)
        yield module
    finally:
        setattr(module, "load_words", old_load_words)
